...
template <typename T>
BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(T begin, T end) noexcept -> sha3_512_hasher::return_type
{
    if (end < begin)
    {
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const char* str) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const char* str, boost::crypt::size_t len) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const boost::crypt::uint8_t* str) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const boost::crypt::uint8_t* str, boost::crypt::size_t len) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const char16_t* str) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const char16_t* str, boost::crypt::size_t len) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const char32_t* str) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const char32_t* str, boost::crypt::size_t len) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const wchar_t* str) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(const wchar_t* str, boost::crypt::size_t len) noexcept -> sha3_512_hasher::return_type
{
    if (str == nullptr)
    {
        return sha3_512_hasher::return_type{}; // LCOV_EXCL_LINE
...
BOOST_CRYPT_EXPORT constexpr auto sha3_512(std::string_view str) -> sha3_512_hasher::return_type
{
    return detail::sha3_512(str.begin(), str.end());
}

BOOST_CRYPT_EXPORT constexpr auto sha3_512(std::u16string_view str) -> sha3_512_hasher::return_type
{
    return detail::sha3_512(str.begin(), str.end());
}

BOOST_CRYPT_EXPORT constexpr auto sha3_512(std::u32string_view str) -> sha3_512_hasher::return_type
{
    return detail::sha3_512(str.begin(), str.end());
}

BOOST_CRYPT_EXPORT constexpr auto sha3_512(std::wstring_view str) -> sha3_512_hasher::return_type
{
    return detail::sha3_512(str.begin(), str.end());
}
...
BOOST_CRYPT_EXPORT inline auto sha3_512_file(const std::string& filepath) noexcept -> sha3_512_hasher::return_type
{
    try
    {
        utility::file_reader<72U> reader(filepath);
...
constexpr auto sha3_512(std::span<T, extent> data) noexcept -> sha3_512_hasher::return_type
{
...
BOOST_CRYPT_GPU_ENABLED constexpr auto sha3_512(cuda::std::span<T, extent> data) noexcept -> sha3_512_hasher::return_type
{
    return detail::sha3_512(data.begin(), data.end());
}
