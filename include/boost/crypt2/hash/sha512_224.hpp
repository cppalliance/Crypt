...
#ifndef BOOST_CRYPT2_HASH_SHA512_224_HPP
#define BOOST_CRYPT2_HASH_SHA512_224_HPP
...
auto sha512_224(compat::span<const compat::byte> data) noexcept -> compat::expected<sha512_224_hasher::return_type, state>
{
...
auto sha512_224(SizedRange&& data) noexcept -> compat::expected<sha512_224_hasher::return_type, state>
{
    sha512_224_hasher hasher;
    hasher.process_bytes(data);
    hasher.finalize();
...
[[nodiscard]] inline auto sha512_224_file_impl(detail::file_reader<64U>& reader) -> compat::expected<sha512_224_hasher::return_type, state>
{
    sha512_224_hasher hasher;
    while (!reader.eof())
    {
...
#endif //BOOST_CRYPT2_HASH_SHA512_224_HPP
