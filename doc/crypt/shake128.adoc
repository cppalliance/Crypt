...
template <concepts::file_system_path T>
[[nodiscard]] inline auto shake128_file(const T& filepath, std::span<std::byte> out) -> state;

template <concepts::file_system_path T>
[[nodiscard]] inline auto shake128_file(const T& filepath, std::span<std::byte> out, std::size_t amount) -> state;
