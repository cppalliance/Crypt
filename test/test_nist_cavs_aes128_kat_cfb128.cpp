...
auto main() -> int
{
    const std::vector<std::string> files_to_test = {
        ...
        "CFB128VarKey128.rsp",
        "CFB128VarTxt128.rsp",
        "CFB128GFSbox128_20.rsp",
        "CFB128KeySbox128_20.rsp",
        "CFB128VarKey128_20.rsp",
        "CFB128VarTxt128_20.rsp"
    };
    ...
    for (const auto& file : files_to_test)
    {
        ...
        const bool result_is_ok = (nist::cavs::test_vectors_aes_kat<boost::crypt::aes::cipher_mode::cfb128, boost::crypt::aes128>(test_vectors));
