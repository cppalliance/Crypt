...
using digest_type = boost::crypt::sha256_hasher::return_type;
extern "C" __global__
void test_sha256_kernel(char** in, digest_type* out, int numElements)
{
...
int main()
{
    try
    {
        ...
        res = nvrtcCreateProgram(&prog, cuda_kernel, "test_sha256_kernel.cu", 0, nullptr, nullptr);
        ...
        checkCUError(cuModuleGetFunction(&kernel, module, "test_sha256_kernel"), "Failed to get kernel function");
        ...
        for (int i = 0; i < numElements; ++i)
        {
            auto res = boost::crypt::sha256(input_vector1[i]);
