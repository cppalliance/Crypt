...
auto main() -> int
{
...

    {
        ...
        static_cast<void>(nist::cavs::detail::parse_file_vectors("SHA256ShortMsg.rsp", test_vectors_short));
...

    {
        ...
        static_cast<void>(nist::cavs::detail::parse_file_vectors("SHA256LongMsg.rsp", test_vectors_long));

        result_is_ok = (nist::cavs::test_vectors_oneshot<boost::crypt::sha256_hasher>(test_vectors_long) && result_is_ok);
