...
#ifndef BOOST_CRYPT_TEST_WHERE_FILE_HPP
#define BOOST_CRYPT_TEST_WHERE_FILE_HPP
...
auto where_file(const std::string& test_vectors_filename) -> std::string
{
    ...
    // Boost-root
    std::string test_vectors_filename_relative = "libs/crypt/test/" + test_vectors_filename;
    ...
    else
    {
        ...
        test_vectors_filename_relative = "../test/" + test_vectors_filename;
        ...
        else
        {
            ...
            {
                // CMake builds
                test_vectors_filename_relative = "../../../../libs/crypt/test/" + test_vectors_filename;
...
#endif //BOOST_CRYPT_TEST_WHERE_FILE_HPP
