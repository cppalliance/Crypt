...
constexpr std::array<std::tuple<const char*, std::array<uint16_t, 20>>, 8> test_values =
{
    ...
    std::make_tuple("a",
                    std::array<std::uint16_t, 20>{0x34, 0xAA, 0x97, 0x3C, 0xD4, 0xC4, 0xDA, 0xA4, 0xF6, 0x1E,
                                                  0xEB, 0x2B, 0xDB, 0xAD, 0x27, 0x31, 0x65, 0x34, 0x01, 0x6F}),

    std::make_tuple("0123456701234567012345670123456701234567012345670123456701234567",
                    std::array<std::uint16_t, 20>{0xDE, 0xA3, 0x56, 0xA2, 0xCD, 0xDD, 0x90, 0xC7, 0xA7, 0xEC,
