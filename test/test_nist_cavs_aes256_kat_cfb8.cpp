...
auto main() -> int
{
    const std::vector<std::string> files_to_test = {
        ...
        "CFB8VarKey256.rsp",
        "CFB8VarTxt256.rsp",
        "CFB8GFSbox256_20.rsp",
        "CFB8KeySbox256_20.rsp",
        "CFB8VarKey256_20.rsp",
        "CFB8VarTxt256_20.rsp"
    };
    ...
    for (const auto& file : files_to_test)
    {
        ...
        const bool result_is_ok = (nist::cavs::test_vectors_aes_kat<boost::crypt::aes::cipher_mode::cfb8, boost::crypt::aes256>(test_vectors));
